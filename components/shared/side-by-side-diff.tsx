...
export function SideBySideDiff({ pcCommercialSpan, kinsaleSpan, tightness, mechanism }: {
  pcCommercialSpan: EvidenceSpanType; kinsaleSpan: EvidenceSpanType; tightness: TightnessDirection; mechanism: MechanismType;
}) {
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <h4 className="text-sm font-medium text-muted-foreground">P&C Commercial</h4>
          <EvidenceSpan span={pcCommercialSpan} highlightColor="bg-green-100" />
        </div>
        <div className="space-y-2">
