    ...
    async with factory() as session:
        ...
        submission_defs = [
            ...
            },
            {
                ...
                "status": SubmissionStatus.PREPARING_TO_UW,
            ...
            },
            {
                ...
                "status": SubmissionStatus.AI_UNDERWRITING,
                "line_of_business": "General Liability",
            ...
            },
            {
                ...
                "status": SubmissionStatus.READY_FOR_UW_REVIEW,
        ...
        loss_run_defs = [
            ...
            {"id": "lr-011", "submission_id": "ps-003", "policy_year": "2021-2022", "carrier": "P&C Commercial", "premium": 55000.0, "claim_count": 3, "incurred": 31000.0, "paid": 28000.0, "reserves": 3000.0, "loss_ratio": 0.564, "sort_order": 3},
        ]
        ...
        timeline_data = [
            ("ps-001", [
                (None, "preparing_to_uw", "2026-02-15T09:30:00", "System", None),
                ("preparing_to_uw", "ai_underwriting", "2026-02-15T09:31:00", "System", "AI underwriting started"),
                ("ai_underwriting", "ready_for_uw_review", "2026-02-16T10:15:00", "System", "AI review complete"),
                ("ready_for_uw_review", "under_review", "2026-03-01T14:00:00", "Sarah Chen", "Reviewing loss runs and application"),
            ]),
            ("ps-002", [
                (None, "preparing_to_uw", "2026-01-20T11:00:00", "System", None),
                ("preparing_to_uw", "ai_underwriting", "2026-01-20T11:01:00", "System", None),
                ("ai_underwriting", "ready_for_uw_review", "2026-01-21T08:30:00", "System", None),
                ("ready_for_uw_review", "under_review", "2026-02-05T09:00:00", "Michael Torres", None),
                ("under_review", "proposal_produced", "2026-03-08T16:45:00", "Michael Torres", "Good/Better/Best options created"),
            ]),
            ("ps-003", [
                (None, "preparing_to_uw", "2025-12-10T14:00:00", "System", None),
                ("preparing_to_uw", "ai_underwriting", "2025-12-10T14:01:00", "System", None),
                ("ai_underwriting", "ready_for_uw_review", "2025-12-11T09:00:00", "System", None),
                ("ready_for_uw_review", "under_review", "2025-12-20T10:30:00", "Sarah Chen", None),
            ...
            ("ps-004", [
                (None, "preparing_to_uw", "2026-03-12T08:00:00", "System", None),
            ]),
            ("ps-005", [
                (None, "preparing_to_uw", "2026-02-01T10:00:00", "System", None),
                ("preparing_to_uw", "ai_underwriting", "2026-02-01T10:01:00", "System", None),
                ("ai_underwriting", "ready_for_uw_review", "2026-02-02T09:15:00", "System", None),
                ("ready_for_uw_review", "under_review", "2026-02-10T11:00:00", "Sarah Chen", None),
                ("under_review", "declined", "2026-02-20T14:00:00", "Sarah Chen", "Loss history outside appetite \u2014 3 liquor liability claims in 2 years"),
            ]),
            ("ps-006", [
                (None, "preparing_to_uw", "2026-03-05T13:30:00", "System", None),
                ("preparing_to_uw", "ai_underwriting", "2026-03-06T08:00:00", "System", "AI underwriting in progress"),
            ]),
            ("ps-007", [
                (None, "preparing_to_uw", "2025-11-15T10:00:00", "System", None),
                ("preparing_to_uw", "ai_underwriting", "2025-11-15T10:01:00", "System", None),
                ("ai_underwriting", "ready_for_uw_review", "2025-11-16T09:00:00", "System", None),
                ("ready_for_uw_review", "under_review", "2025-11-25T10:00:00", "Sarah Chen", None),
            ...
            ("ps-008", [
                (None, "preparing_to_uw", "2026-02-28T09:00:00", "System", None),
                ("preparing_to_uw", "ai_underwriting", "2026-02-28T09:01:00", "System", None),
                ("ai_underwriting", "ready_for_uw_review", "2026-03-14T09:00:00", "System", "AI review complete — ready for underwriter"),
            ]),
            ("ps-009", [
                (None, "preparing_to_uw", "2026-03-16T15:00:00", "System", None),
            ]),
        ]
