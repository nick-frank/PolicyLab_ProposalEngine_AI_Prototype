...
export const PORTAL_SUBMISSIONS: PortalSubmission[] = [
  {
    ...
    brokerContact: "Tom Richardson",
    brokerEmail: "tom.richardson@marsh.com",
    brokerPhone: "(408) 555-0142",
    state: "CA",
    primaryAddress: "1500 Industrial Pkwy, San Jose, CA 95131",
    naicsCode: "236220",
    naicsDescription: "Commercial Building Construction",
    companyUrl: "https://pacificcoastbuilders.com",
    insuredLocations: [
      { address: "1500 Industrial Pkwy, San Jose, CA 95131", type: "Primary", description: "Main office and equipment yard", reportable: true, effectiveStart: "2026-04-01", effectiveEnd: "2027-04-01" },
      { address: "2800 Harbor Blvd, Suite 200, Costa Mesa, CA 92626", type: "Branch", description: "Southern California project office", reportable: true, effectiveStart: "2026-04-01", effectiveEnd: "2027-04-01" },
      { address: "4100 Redwood Rd, Oakland, CA 94619", type: "Warehouse", description: "Material storage facility", reportable: false, effectiveStart: "2026-04-01", effectiveEnd: "2027-04-01" },
    ],
    submissionSummary: "Pacific Coast Builders LLC is a commercial building contractor operating across 3 California locations with annual revenue of $4.2M and 45 employees. The insured specializes in commercial building construction and tenant improvements with 35% subcontracted work. Loss history shows a concerning 2021-2022 year (87.5% loss ratio) driven by a scaffolding collapse incident, though a comprehensive fall protection program was implemented in Q1 2022. Subsequent years show improved performance. The account is presented by Marsh McLennan for a General Liability occurrence program effective 04/01/2026.",
    timeline: [
      { status: "preparing_to_uw", timestamp: "2026-02-15T09:30:00Z", user: "System" },
      { status: "ai_underwriting", timestamp: "2026-02-15T09:31:00Z", user: "System", note: "AI underwriting started" },
      { status: "ready_for_uw_review", timestamp: "2026-02-16T10:15:00Z", user: "System", note: "AI review complete" },
  ...
  },
  {
    ...
    brokerContact: "Lisa Nguyen",
    brokerEmail: "lisa.nguyen@aon.com",
    brokerPhone: "(212) 555-0198",
    state: "NY",
    primaryAddress: "200 Park Ave, Suite 1500, New York, NY 10166",
    naicsCode: "541512",
    naicsDescription: "Computer Systems Design Services",
    companyUrl: "https://meridiantech.io",
    insuredLocations: [
      { address: "200 Park Ave, Suite 1500, New York, NY 10166", type: "Primary", description: "Corporate headquarters", reportable: true, effectiveStart: "2026-05-01", effectiveEnd: "2027-05-01" },
    ],
    submissionSummary: "Meridian Tech Solutions Inc. is an IT consulting and custom software development firm based in New York with 85 employees and $8.5M in annual revenue. SOC2 certified with strong risk management practices. Clean loss history except one E&O claim in 2022-2023 that was resolved favorably. The account is presented by Aon Risk Solutions for Professional Liability coverage with Good/Better/Best proposal options.",
    timeline: [
      { status: "preparing_to_uw", timestamp: "2026-01-20T11:00:00Z", user: "System" },
      { status: "ai_underwriting", timestamp: "2026-01-20T11:01:00Z", user: "System" },
      { status: "ready_for_uw_review", timestamp: "2026-01-21T08:30:00Z", user: "System" },
  ...
  },
  {
    ...
    brokerContact: "James Park",
    brokerEmail: "james.park@wtwco.com",
    brokerPhone: "(713) 555-0267",
    state: "TX",
    primaryAddress: "4200 Medical Center Dr, Houston, TX 77004",
    naicsCode: "621111",
    naicsDescription: "Offices of Physicians",
    companyUrl: "https://summithealthcaregroup.com",
    insuredLocations: [
      { address: "4200 Medical Center Dr, Houston, TX 77004", type: "Primary", description: "Main medical office", reportable: true, effectiveStart: "2026-03-01", effectiveEnd: "2027-03-01" },
      { address: "1100 Holcombe Blvd, Houston, TX 77030", type: "Clinic", description: "Satellite clinic", reportable: true, effectiveStart: "2026-03-01", effectiveEnd: "2027-03-01" },
    ],
    timeline: [
      { status: "preparing_to_uw", timestamp: "2025-12-10T14:00:00Z", user: "System" },
      { status: "ai_underwriting", timestamp: "2025-12-10T14:01:00Z", user: "System" },
      { status: "ready_for_uw_review", timestamp: "2025-12-11T09:00:00Z", user: "System" },
  ...
  },
  {
    ...
    brokerContact: "Rachel Adams",
    brokerEmail: "rachel.adams@lockton.com",
    brokerPhone: "(216) 555-0331",
    state: "OH",
    primaryAddress: "8700 Brookpark Rd, Cleveland, OH 44129",
    naicsCode: "332710",
    naicsDescription: "Machine Shops",
    companyUrl: "https://greenfieldmfg.com",
    insuredLocations: [
      { address: "8700 Brookpark Rd, Cleveland, OH 44129", type: "Primary", description: "Manufacturing plant and offices", reportable: true, effectiveStart: "2026-06-01", effectiveEnd: "2027-06-01" },
    ],
    timeline: [
      { status: "preparing_to_uw", timestamp: "2026-03-12T08:00:00Z", user: "System" },
    ],
  },
  {
    id: "ps-005",
    ...
    broker: "Brown & Brown",
    brokerContact: "David Martinez",
    brokerEmail: "david.martinez@bbrown.com",
    brokerPhone: "(954) 555-0415",
    state: "FL",
    primaryAddress: "1200 Ocean Blvd, Fort Lauderdale, FL 33316",
    naicsCode: "722511",
    naicsDescription: "Full-Service Restaurants",
    companyUrl: "https://coastaldining.com",
    insuredLocations: [
      { address: "1200 Ocean Blvd, Fort Lauderdale, FL 33316", type: "Primary", description: "Flagship restaurant and offices", reportable: true, effectiveStart: "2026-04-15", effectiveEnd: "2027-04-15" },
      { address: "800 Brickell Ave, Miami, FL 33131", type: "Restaurant", description: "Downtown Miami location", reportable: true, effectiveStart: "2026-04-15", effectiveEnd: "2027-04-15" },
      { address: "450 Lincoln Rd, Miami Beach, FL 33139", type: "Restaurant", description: "Miami Beach location", reportable: true, effectiveStart: "2026-04-15", effectiveEnd: "2027-04-15" },
    ],
    timeline: [
      { status: "preparing_to_uw", timestamp: "2026-02-01T10:00:00Z", user: "System" },
      { status: "ai_underwriting", timestamp: "2026-02-01T10:01:00Z", user: "System" },
      { status: "ready_for_uw_review", timestamp: "2026-02-02T09:15:00Z", user: "System" },
  ...
  },
  {
    ...
    broker: "Gallagher",
    brokerContact: "Kevin O'Brien",
    brokerEmail: "kevin.obrien@ajg.com",
    brokerPhone: "(312) 555-0578",
    state: "IL",
    primaryAddress: "550 W Adams St, Suite 300, Chicago, IL 60661",
    naicsCode: "561612",
    naicsDescription: "Security Guards and Patrol Services",
    companyUrl: "https://apexsecurity.net",
    insuredLocations: [
      { address: "550 W Adams St, Suite 300, Chicago, IL 60661", type: "Primary", description: "Regional headquarters", reportable: true, effectiveStart: "2026-05-15", effectiveEnd: "2027-05-15" },
    ],
    timeline: [
      { status: "preparing_to_uw", timestamp: "2026-03-05T13:30:00Z", user: "System" },
      { status: "ai_underwriting", timestamp: "2026-03-06T08:00:00Z", user: "System", note: "AI underwriting in progress" },
    ],
  },
  {
    id: "ps-007",
    ...
    brokerContact: "Amy Walsh",
    brokerEmail: "amy.walsh@hubinternational.com",
    brokerPhone: "(602) 555-0693",
    state: "AZ",
    primaryAddress: "3030 N Central Ave, Suite 800, Phoenix, AZ 85012",
    naicsCode: "531311",
    naicsDescription: "Residential Property Managers",
    companyUrl: "https://riversidepropmgmt.com",
    insuredLocations: [
      { address: "3030 N Central Ave, Suite 800, Phoenix, AZ 85012", type: "Primary", description: "Corporate office", reportable: true, effectiveStart: "2026-01-01", effectiveEnd: "2027-01-01" },
      { address: "7200 E Camelback Rd, Scottsdale, AZ 85251", type: "Managed Property", description: "Residential complex — 120 units", reportable: false, effectiveStart: "2026-01-01", effectiveEnd: "2027-01-01" },
    ],
    timeline: [
      { status: "preparing_to_uw", timestamp: "2025-11-15T10:00:00Z", user: "System" },
      { status: "ai_underwriting", timestamp: "2025-11-15T10:01:00Z", user: "System" },
      { status: "ready_for_uw_review", timestamp: "2025-11-16T09:00:00Z", user: "System" },
  ...
  },
  {
    ...
    brokerPhone: "(770) 555-0824",
    state: "GA",
    primaryAddress: "1400 Peachtree Industrial Blvd, Duluth, GA 30097",
    naicsCode: "484121",
    naicsDescription: "General Freight Trucking, Long-Distance",
    companyUrl: "https://northstarlogistics.com",
    insuredLocations: [
      { address: "1400 Peachtree Industrial Blvd, Duluth, GA 30097", type: "Primary", description: "Main terminal and dispatch", reportable: true, effectiveStart: "2026-07-01", effectiveEnd: "2027-07-01" },
      { address: "2200 Fulton Industrial Blvd, Atlanta, GA 30336", type: "Distribution Center", description: "Cross-dock and freight staging", reportable: true, effectiveStart: "2026-07-01", effectiveEnd: "2027-07-01" },
    ],
    timeline: [
      { status: "preparing_to_uw", timestamp: "2026-02-28T09:00:00Z", user: "System" },
      { status: "ai_underwriting", timestamp: "2026-02-28T09:01:00Z", user: "System" },
      { status: "ready_for_uw_review", timestamp: "2026-03-14T09:00:00Z", user: "System", note: "AI review complete — ready for underwriter" },
    ],
  },
  {
    id: "ps-009",
    ...
    expirationDate: "2027-06-01",
    broker: "Aon Risk Solutions",
    brokerContact: "Mark Chen",
    brokerEmail: "mark.chen@aon.com",
    brokerPhone: "(206) 555-0917",
    state: "WA",
    primaryAddress: "701 Pike St, Suite 1200, Seattle, WA 98101",
    naicsCode: "541519",
    naicsDescription: "Other Computer Related Services",
    companyUrl: "https://bluewavecyber.io",
    insuredLocations: [
      { address: "701 Pike St, Suite 1200, Seattle, WA 98101", type: "Primary", description: "Office and consulting center", reportable: true, effectiveStart: "2026-06-01", effectiveEnd: "2027-06-01" },
    ],
    timeline: [
      { status: "preparing_to_uw", timestamp: "2026-03-16T15:00:00Z", user: "System" },
    ],
  },
];
...
export const PORTAL_PROPOSALS: PortalProposal[] = [
  {
    ...
    description: "Base GL coverage with occurrence form, cyber exclusion credit, and waiver of subrogation. Minimum viable program for contractor class.",
    aiGenerated: true,
    version: 1,
    status: "draft",
    totalPremium: 45000,
  ...
  },
  {
    id: "prop-001b",
    submissionId: "ps-001",
    label: "Enhanced GL Program",
    description: "Broader GL program with EBL coverage and blanket additional insured. Recommended for accounts with significant subcontractor exposure.",
    version: 2,
    ...
    forms: [
      {
        ...
        customAdjustment: 0,
        debitsCredits: [
          { id: "dc-101", description: "Base premium", type: "debit", amount: 42000 },
        ],
      },
      {
        id: "f-001b-2",
        ...
        customAdjustment: -5,
        debitsCredits: [
          { id: "dc-102", description: "Cyber exclusion credit", type: "credit", amount: 2100 },
        ],
      },
      {
        id: "f-001b-3",
        ...
        customAdjustment: 3,
        debitsCredits: [
          { id: "dc-103", description: "Waiver of subrogation charge", type: "debit", amount: 1260 },
        ],
      },
      {
        id: "f-001b-4",
        ...
        type: "endorsement",
        defaultAdjustment: 12,
        customAdjustment: 12,
        debitsCredits: [
          { id: "dc-104", description: "EBL coverage premium", type: "debit", amount: 5040 },
        ],
      },
      {
        id: "f-001b-5",
        formNumber: "MEGL 0009-01",
        formName: "Blanket Additional Insured",
        type: "endorsement",
        defaultAdjustment: 5,
        customAdjustment: 5,
        debitsCredits: [
          { id: "dc-105", description: "Blanket AI surcharge", type: "debit", amount: 2100 },
          { id: "dc-106", description: "Multi-year discount", type: "credit", amount: 500 },
        ],
      },
    ],
  },
  {
    id: "prop-001c",
    submissionId: "ps-001",
    label: "Standard GL Program (Copy)",
    description: "Editable copy of the AI-generated Standard GL Program. Base GL coverage with occurrence form, cyber exclusion credit, and waiver of subrogation.",
    version: 3,
    status: "draft",
    totalPremium: 45000,
    basePremium: 38000,
    ...
    forms: [
      {
        ...
        customAdjustment: 0,
        debitsCredits: [
          { id: "dc-201", description: "Base premium", type: "debit", amount: 38000 },
        ],
      },
      {
        id: "f-001c-2",
        ...
        customAdjustment: -5,
        debitsCredits: [
          { id: "dc-202", description: "Cyber exclusion credit", type: "credit", amount: 1900 },
        ],
      },
      {
        id: "f-001c-3",
        ...
        customAdjustment: 3,
        debitsCredits: [
          { id: "dc-203", description: "Waiver of subrogation charge", type: "debit", amount: 1140 },
        ],
      },
    ],
  },
  {
    ...
    description: "Entry-level professional liability with Tech E&O extension. Base option for broker presentation.",
    version: 1,
    status: "approved",
    totalPremium: 22000,
    basePremium: 20000,
  ...
  },
  {
    ...
    description: "Enhanced PL with cyber incident response coverage. Recommended tier given SOC2 compliance posture.",
    version: 2,
    status: "pending_approval",
    totalPremium: 28500,
    basePremium: 24000,
  ...
  },
  {
    ...
    description: "Standard healthcare GL package with EBL coverage and abuse/molestation exclusion for physician group.",
    version: 1,
    status: "approved",
    totalPremium: 72000,
    basePremium: 62000,
...
export const PORTAL_LOSS_RUNS: Record<string, PortalLossRun[]> = {
  ...
  "ps-003": [
    ...
    { id: "lr-011", submissionId: "ps-003", policyYear: "2021-2022", carrier: "P&C Commercial", premium: 55000, claims: 3, incurred: 31000, paid: 28000, reserves: 3000, lossRatio: 0.564 },
  ],
};
...
// ── Loss Details (individual loss records keyed by submissionId) ─────

export const PORTAL_LOSS_DETAILS: Record<string, PortalLossDetail[]> = {
  "ps-001": [
    { id: "ld-001", dateOfLoss: "2023-09-15", groundUpIndemnity: 8500, groundUpExpense: 2000, groundUpTotalIncurred: 10500, indemnityLessDeductible: 3500, includableLosses: 3500, policyPeriod: "2023-2024" },
    { id: "ld-002", dateOfLoss: "2023-04-22", groundUpIndemnity: 1500, groundUpExpense: 500, groundUpTotalIncurred: 2000, indemnityLessDeductible: 0, includableLosses: 0, policyPeriod: "2023-2024" },
    { id: "ld-003", dateOfLoss: "2022-11-03", groundUpIndemnity: 4200, groundUpExpense: 1000, groundUpTotalIncurred: 5200, indemnityLessDeductible: 0, includableLosses: 0, policyPeriod: "2022-2023" },
    { id: "ld-004", dateOfLoss: "2021-08-14", groundUpIndemnity: 18000, groundUpExpense: 4000, groundUpTotalIncurred: 22000, indemnityLessDeductible: 13000, includableLosses: 13000, policyPeriod: "2021-2022" },
    { id: "ld-005", dateOfLoss: "2021-12-01", groundUpIndemnity: 3500, groundUpExpense: 1200, groundUpTotalIncurred: 4700, indemnityLessDeductible: 0, includableLosses: 0, policyPeriod: "2021-2022" },
    { id: "ld-006", dateOfLoss: "2022-02-18", groundUpIndemnity: 1000, groundUpExpense: 300, groundUpTotalIncurred: 1300, indemnityLessDeductible: 0, includableLosses: 0, policyPeriod: "2021-2022" },
    { id: "ld-007", dateOfLoss: "2019-06-10", groundUpIndemnity: 6500, groundUpExpense: 2000, groundUpTotalIncurred: 8500, indemnityLessDeductible: 1500, includableLosses: 1500, policyPeriod: "2019-2020" },
  ],
  "ps-003": [
    { id: "ld-008", dateOfLoss: "2024-01-20", groundUpIndemnity: 22000, groundUpExpense: 6000, groundUpTotalIncurred: 28000, indemnityLessDeductible: 17000, includableLosses: 17000, policyPeriod: "2023-2024" },
    { id: "ld-009", dateOfLoss: "2023-07-11", groundUpIndemnity: 8000, groundUpExpense: 2500, groundUpTotalIncurred: 10500, indemnityLessDeductible: 3000, includableLosses: 3000, policyPeriod: "2023-2024" },
    { id: "ld-010", dateOfLoss: "2023-03-05", groundUpIndemnity: 2000, groundUpExpense: 1500, groundUpTotalIncurred: 3500, indemnityLessDeductible: 0, includableLosses: 0, policyPeriod: "2023-2024" },
    { id: "ld-011", dateOfLoss: "2022-09-14", groundUpIndemnity: 12000, groundUpExpense: 6000, groundUpTotalIncurred: 18000, indemnityLessDeductible: 7000, includableLosses: 7000, policyPeriod: "2022-2023" },
    { id: "ld-012", dateOfLoss: "2021-11-30", groundUpIndemnity: 20000, groundUpExpense: 5000, groundUpTotalIncurred: 25000, indemnityLessDeductible: 15000, includableLosses: 15000, policyPeriod: "2021-2022" },
    { id: "ld-013", dateOfLoss: "2022-01-15", groundUpIndemnity: 4000, groundUpExpense: 2000, groundUpTotalIncurred: 6000, indemnityLessDeductible: 0, includableLosses: 0, policyPeriod: "2021-2022" },
  ],
};
...
export const PORTAL_NOTES: Record<string, PortalNote[]> = {
  "ps-001": [
    ...
    { id: "n-002", submissionId: "ps-001", type: "email", author: "Sarah Chen", timestamp: "2026-03-05T10:00:00Z", content: "Hi Tom, could you provide updated safety program documentation and any OSHA inspection reports from the past 2 years? Also need confirmation on the subcontractor management program. Thanks, Sarah", from: "sarah.chen@pccommercial.com", to: "tom.broker@marsh.com", subject: "RE: Pacific Coast Builders — Additional Information Needed" },
    { id: "n-003", submissionId: "ps-001", type: "email", author: "Tom Broker", timestamp: "2026-03-07T16:15:00Z", content: "Sarah, attached are the safety program docs and OSHA reports. Clean record since the 2021 incident. They implemented a comprehensive fall protection program in Q1 2022. Subcontractor qualification docs to follow. — Tom", from: "tom.broker@marsh.com", to: "sarah.chen@pccommercial.com", subject: "RE: Pacific Coast Builders — Additional Information Needed" },
...
export const PORTAL_PROPOSAL_RATES: Record<string, PortalRate[]> = {
  "prop-001": [
    { id: "pr-001", submissionId: "ps-001", locationAddress: "1500 Industrial Pkwy, San Jose, CA 95131", classCode: "91580", classDescription: "Contractors — General (Subcontracted Work)", territory: "CA-01", baseRate: 12.50, exposure: 1500000, exposureBase: "Payroll", manualPremium: 18750, lcm: 1.20, adjustedPremium: 22500 },
    { id: "pr-002", submissionId: "ps-001", locationAddress: "2800 Harbor Blvd, Suite 200, Costa Mesa, CA 92626", classCode: "91340", classDescription: "Contractors — Carpentry", territory: "CA-01", baseRate: 8.75, exposure: 800000, exposureBase: "Payroll", manualPremium: 7000, lcm: 1.10, adjustedPremium: 7700 },
    { id: "pr-003", submissionId: "ps-001", locationAddress: "4100 Redwood Rd, Oakland, CA 94619", classCode: "91150", classDescription: "Contractors — Concrete Work", territory: "CA-01", baseRate: 15.20, exposure: 600000, exposureBase: "Payroll", manualPremium: 9120, lcm: 1.15, adjustedPremium: 10488 },
  ],
  "prop-001c": [
    { id: "pr-201", submissionId: "ps-001", locationAddress: "1500 Industrial Pkwy, San Jose, CA 95131", classCode: "91580", classDescription: "Contractors — General (Subcontracted Work)", territory: "CA-01", baseRate: 12.50, exposure: 1500000, exposureBase: "Payroll", manualPremium: 18750, lcm: 1.20, adjustedPremium: 22500 },
    { id: "pr-202", submissionId: "ps-001", locationAddress: "2800 Harbor Blvd, Suite 200, Costa Mesa, CA 92626", classCode: "91340", classDescription: "Contractors — Carpentry", territory: "CA-01", baseRate: 8.75, exposure: 800000, exposureBase: "Payroll", manualPremium: 7000, lcm: 1.10, adjustedPremium: 7700 },
    { id: "pr-203", submissionId: "ps-001", locationAddress: "4100 Redwood Rd, Oakland, CA 94619", classCode: "91150", classDescription: "Contractors — Concrete Work", territory: "CA-01", baseRate: 15.20, exposure: 600000, exposureBase: "Payroll", manualPremium: 9120, lcm: 1.15, adjustedPremium: 10488 },
  ],
  "prop-001b": [
    { id: "pr-101", submissionId: "ps-001", locationAddress: "1500 Industrial Pkwy, San Jose, CA 95131", classCode: "91580", classDescription: "Contractors — General (Subcontracted Work)", territory: "CA-01", baseRate: 13.80, exposure: 1500000, exposureBase: "Payroll", manualPremium: 20700, lcm: 1.20, adjustedPremium: 24840 },
    { id: "pr-102", submissionId: "ps-001", locationAddress: "2800 Harbor Blvd, Suite 200, Costa Mesa, CA 92626", classCode: "91340", classDescription: "Contractors — Carpentry", territory: "CA-01", baseRate: 9.50, exposure: 800000, exposureBase: "Payroll", manualPremium: 7600, lcm: 1.10, adjustedPremium: 8360 },
    { id: "pr-103", submissionId: "ps-001", locationAddress: "4100 Redwood Rd, Oakland, CA 94619", classCode: "91150", classDescription: "Contractors — Concrete Work", territory: "CA-01", baseRate: 16.00, exposure: 600000, exposureBase: "Payroll", manualPremium: 9600, lcm: 1.15, adjustedPremium: 11040 },
  ],
  "prop-002": [
...
export const PORTAL_PROPOSAL_NOTES: Record<string, PortalNote[]> = {
  ...
  "prop-001c": [
    { id: "pn-201", submissionId: "ps-001", type: "note", author: "Sarah Chen", timestamp: "2026-03-15T09:00:00Z", content: "Copied from AI-generated Standard GL Program (v1) for manual adjustments. Reviewing rates and form schedule." },
  ],
  "prop-001b": [
    { id: "pn-101", submissionId: "ps-001", type: "note", author: "Sarah Chen", timestamp: "2026-03-12T10:00:00Z", content: "Enhanced GL program adds EBL coverage and blanket additional insured. Higher base rate reflects broader coverage scope. Recommended option for this account given subcontractor exposure." },
    { id: "pn-102", submissionId: "ps-001", type: "note", author: "Jennifer Park", timestamp: "2026-03-13T09:30:00Z", content: "Reviewing enhanced program. Premium increase of ~$7K over standard seems justified by the EBL and blanket AI additions. Awaiting final safety documentation before approval." },
  ],
  "prop-002": [
...
export const PORTAL_PROPOSAL_FORMS: Record<string, SubmissionForm[]> = {
  "prop-001": [
    ...
    { id: "pf-001-09", formNumber: "MEIL 1231", edition: "10 13", formName: "Minimum Earned Premium And Minimum Retained Premium", type: "endorsement", category: "GL Endorsements", fillIns: [{ id: "fi-001", label: "Minimum Earned Premium Percentage", value: "25" }, { id: "fi-002", label: "Minimum Retained Premium Percentage", value: "100" }] },
    { id: "pf-001-10", formNumber: "CG 21 34", edition: "01 87", formName: "Designated Work Exclusion", type: "exclusion", category: "GL Endorsements", description: "Description of your work: highway/bridge work, dam work", adjustments: [{ id: "padj-010", description: "Designated work exclusion credit", type: "credit", amount: 850 }], fillIns: [{ id: "fi-003", label: "Description of Designated Work", value: "Highway/bridge work, dam work" }] },
  ],
  "prop-001c": [
    { id: "pf-001c-01", formNumber: "MJIL 1000", edition: "08 10", formName: "Policy Jacket (Evanston)", type: "policy", category: "Common Policy" },
    { id: "pf-001c-02", formNumber: "MDIL 1000", edition: "08 11", formName: "Common Policy Declaration", type: "policy", category: "Common Policy", description: "Form of Business: Limited Liability Corporation" },
    { id: "pf-001c-03", formNumber: "IL 00 17", edition: "11 98", formName: "Common Policy Conditions", type: "policy", category: "Common Policy" },
    { id: "pf-001c-04", formNumber: "IL 00 21", edition: "09 08", formName: "Nuclear Energy Liability Exclusion Endorsement", type: "exclusion", category: "Common Policy" },
    { id: "pf-001c-05", formNumber: "CG 00 01", edition: "04 13", formName: "Commercial General Liability Coverage Form", type: "coverage", category: "GL Coverage" },
    { id: "pf-001c-06", formNumber: "MDGL 1008", edition: "08 11", formName: "Commercial General Liability Coverage Part Declarations", type: "coverage", category: "GL Coverage" },
    { id: "pf-001c-07", formNumber: "CG 21 06", edition: "05 14", formName: "Exclusion — Access or Disclosure of Confidential Information", type: "exclusion", category: "GL Endorsements", adjustments: [{ id: "padj-201", description: "Cyber exclusion credit", type: "credit", amount: 1900 }] },
    { id: "pf-001c-08", formNumber: "CG 24 04", edition: "05 09", formName: "Waiver of Transfer of Rights of Recovery Against Others", type: "endorsement", category: "GL Endorsements", adjustments: [{ id: "padj-202", description: "Waiver of subrogation charge", type: "debit", amount: 1140 }] },
    { id: "pf-001c-09", formNumber: "MEIL 1231", edition: "10 13", formName: "Minimum Earned Premium And Minimum Retained Premium", type: "endorsement", category: "GL Endorsements", fillIns: [{ id: "fi-201", label: "Minimum Earned Premium Percentage", value: "25" }, { id: "fi-202", label: "Minimum Retained Premium Percentage", value: "100" }] },
    { id: "pf-001c-10", formNumber: "CG 21 34", edition: "01 87", formName: "Designated Work Exclusion", type: "exclusion", category: "GL Endorsements", description: "Description of your work: highway/bridge work, dam work", adjustments: [{ id: "padj-210", description: "Designated work exclusion credit", type: "credit", amount: 850 }], fillIns: [{ id: "fi-203", label: "Description of Designated Work", value: "Highway/bridge work, dam work" }] },
  ],
  "prop-001b": [
    { id: "pf-001b-01", formNumber: "MJIL 1000", edition: "08 10", formName: "Policy Jacket (Evanston)", type: "policy", category: "Common Policy" },
    { id: "pf-001b-02", formNumber: "MDIL 1000", edition: "08 11", formName: "Common Policy Declaration", type: "policy", category: "Common Policy", description: "Form of Business: Limited Liability Corporation" },
    { id: "pf-001b-03", formNumber: "IL 00 17", edition: "11 98", formName: "Common Policy Conditions", type: "policy", category: "Common Policy" },
    { id: "pf-001b-04", formNumber: "IL 00 21", edition: "09 08", formName: "Nuclear Energy Liability Exclusion Endorsement", type: "exclusion", category: "Common Policy" },
    { id: "pf-001b-05", formNumber: "CG 00 01", edition: "04 13", formName: "Commercial General Liability Coverage Form", type: "coverage", category: "GL Coverage" },
    { id: "pf-001b-06", formNumber: "MDGL 1008", edition: "08 11", formName: "Commercial General Liability Coverage Part Declarations", type: "coverage", category: "GL Coverage" },
    { id: "pf-001b-07", formNumber: "CG 21 06", edition: "05 14", formName: "Exclusion — Access or Disclosure of Confidential Information", type: "exclusion", category: "GL Endorsements", adjustments: [{ id: "padj-101", description: "Cyber exclusion credit", type: "credit", amount: 2100 }] },
    { id: "pf-001b-08", formNumber: "CG 24 04", edition: "05 09", formName: "Waiver of Transfer of Rights of Recovery Against Others", type: "endorsement", category: "GL Endorsements", adjustments: [{ id: "padj-102", description: "Waiver of subrogation charge", type: "debit", amount: 1260 }] },
    { id: "pf-001b-09", formNumber: "CG 04 35", edition: "04 13", formName: "Employee Benefits Liability Coverage", type: "endorsement", category: "GL Endorsements", adjustments: [{ id: "padj-103", description: "EBL coverage premium", type: "debit", amount: 5040 }], fillIns: [{ id: "fi-101", label: "Each Employee Limit", value: "$100,000" }, { id: "fi-102", label: "Aggregate Limit", value: "$500,000" }, { id: "fi-103", label: "Deductible", value: "$1,000" }] },
    { id: "pf-001b-10", formNumber: "MEGL 0009-01", edition: "09 18", formName: "Blanket Additional Insured", type: "endorsement", category: "GL Endorsements", adjustments: [{ id: "padj-104", description: "Blanket AI surcharge", type: "debit", amount: 2100 }, { id: "padj-105", description: "Multi-year discount", type: "credit", amount: 500 }] },
    { id: "pf-001b-11", formNumber: "MEIL 1231", edition: "10 13", formName: "Minimum Earned Premium And Minimum Retained Premium", type: "endorsement", category: "GL Endorsements", fillIns: [{ id: "fi-104", label: "Minimum Earned Premium Percentage", value: "25" }, { id: "fi-105", label: "Minimum Retained Premium Percentage", value: "100" }] },
  ],
  "prop-002": [
